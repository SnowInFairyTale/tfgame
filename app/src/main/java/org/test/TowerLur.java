...
public class TowerLur extends Tower
{
	public TowerLur(MainGame game)
	{
		...
		super.setTowerLevels(new TowerLevel[] {
				new TowerLevel(15, 45f, 30, 1f, 0.8f, 0f),
				new TowerLevel(15, 50f, 60, 1f, 0.8f, 5f),
				new TowerLevel(0x19, 55f, 100, 1f, 0.8f, 5f),
				new TowerLevel(40, 60f, 0x8b, 1f, 0.8f, 5f),
				new TowerLevel(100, 60f, 300, 1f, 0.8f, 5f)
		});
