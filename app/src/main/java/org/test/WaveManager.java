...
public class WaveManager extends DrawableGameComponent implements
    ...
    public WaveManager(MainGame game, Difficulty difficulty) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            this.waves.add(new Wave(game, 8, 0x9b + jiXueLang1 * Math.min(waves.size(), (level + 1) * 60), 1f, 1000.0, 3, 5 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
            ...
            this.waves.add(new Wave(game, 10, 170 + jiXueLang1 * Math.min(waves.size(), (level + 1) * 60), 1f, 600.0, 3, 5 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
            ...
            this.waves.add(new Wave(game, 10, 310 + jiXueLang1 * Math.min(waves.size(), (level + 1) * 60), 1f, 1000.0, 3, 5 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
            ...
            this.waves.add(new Wave(game, 10, 500 + jiXueLang1 * Math.min(waves.size(), (level + 1) * 60), 1f, 1000.0, 3, 5 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
        ...
        for (int i = 0; i < 5; i++) {
            ...
            this.waves.add(new Wave(game, 8, 0x9b + jiXueLang2 * Math.min(waves.size(), (level + 1) * 60), 1f, 1000.0, 3, 10 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
            ...
            this.waves.add(new Wave(game, 10, 170 + jiXueLang2 * Math.min(waves.size(), (level + 1) * 60), 1f, 600.0, 3, 10 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
            ...
            this.waves.add(new Wave(game, 10, 310 + jiXueLang2 * Math.min(waves.size(), (level + 1) * 60), 1f, 1000.0, 3, 10 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
            ...
            this.waves.add(new Wave(game, 10, 500 + jiXueLang2 * Math.min(waves.size(), (level + 1) * 60), 1f, 1000.0, 3, 10 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
        ...
        for (int i = 0; i < 5; i++) {
            ...
            this.waves.add(new Wave(game, 8, 0x9b + jiXueLang3 * Math.min(waves.size(), (level + 1) * 60), 1f, 1000.0, 3, 15 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
            ...
            this.waves.add(new Wave(game, 10, 170 + jiXueLang3 * Math.min(waves.size(), (level + 1) * 60), 1f, 600.0, 3, 15 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
            ...
            this.waves.add(new Wave(game, 10, 310 + jiXueLang3 * Math.min(waves.size(), (level + 1) * 60), 1f, 1000.0, 3, 15 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
            ...
            this.waves.add(new Wave(game, 10, 500 + jiXueLang3 * Math.min(waves.size(), (level + 1) * 60), 1f, 1000.0, 3, 15 + (level - 1) * 3, (level - 1) * 3, MonsterType.Chicken));
        ...
        this.waves.add(new Wave(game, 12, 1000 + baseXueLang3 * waves.size(), 1f, 5000.0, 3, 30 + (level - 1) * 3, 25 + (level - 1) * 3, MonsterType.Peasant));
        this.waves.add(new Wave(game, 10, 900 + baseXueLang3 * waves.size(), 1.8f, 400.0, 3, 30 + (level - 1) * 3, 25 + (level - 1) * 3, MonsterType.Peon));
        this.waves.add(new Wave(game, 20, 850 + baseXueLang3 * waves.size(), 1f, 1000.0, 2, 30 + (level - 1) * 3, 25 + (level - 1) * 3, MonsterType.Berserker));
        this.waves.add(new Wave(game, 6, 0xeac + baseXueLang3 * waves.size(), 0.8f, 1000.0, 3, 50, 25 + (level - 1) * 3, MonsterType.Chieftain));

        int baseXueLang4 = 13;
        for (int i = 0; i < 10; i++) {
            this.waves.add(new Wave(game, 18, 1000 + baseXueLang4 * waves.size(), 1.8f, 400.0, 3, 20 + (level - 1) * 3, 15 + (level - 1) * 3, MonsterType.Peon));
            this.waves.add(new Wave(game, 18, 1000 + baseXueLang4 * waves.size(), 1f, 5000.0, 3, 20 + (level - 1) * 3, 15 + (level - 1) * 3, MonsterType.Peasant));
            this.waves.add(new Wave(game, 20, 1000 + baseXueLang4 * waves.size(), 1f, 1000.0, 2, 20 + (level - 1) * 3, 15 + (level - 1) * 3, MonsterType.Berserker));
            this.waves.add(new Wave(game, 6, 1000 + baseXueLang4 * waves.size(), 1f, 2000.0, 4, 20 + (level - 1) * 3, 15 + (level - 1) * 3, MonsterType.Doctor));
            this.waves.add(new Wave(game, 6, 0xeac + baseXueLang4 * waves.size(), 1f, 1000.0, 30, 20 + (level - 1) * 3, 15 + (level - 1) * 3, MonsterType.Chieftain));
        }

        int baseXueLang5 = 13;
        for (int i = 0; i < 10; i++) {
            this.waves.add(new Wave(game, 18, 1000 + baseXueLang5 * waves.size(), 1.8f, 400.0, 3, 20 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Peon));
            this.waves.add(new Wave(game, 18, 1000 + baseXueLang5 * waves.size(), 1f, 5000.0, 3, 20 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Peasant));
            this.waves.add(new Wave(game, 20, 1000 + baseXueLang5 * waves.size(), 1f, 1000.0, 2, 20 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Berserker));
            this.waves.add(new Wave(game, 6, 1000 + baseXueLang5 * waves.size(), 1f, 2000.0, 4, 20 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Doctor));
            this.waves.add(new Wave(game, 6, 0xeac + baseXueLang5 * waves.size(), 1f, 1000.0, 30, 20 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Chieftain));
        }

        int baseXueLang6 = 13;
        for (int i = 0; i < 10; i++) {
            this.waves.add(new Wave(game, 18, 1000 + baseXueLang6 * waves.size(), 1.8f, 400.0, 3, 30 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Peon));
            this.waves.add(new Wave(game, 18, 1000 + baseXueLang6 * waves.size(), 1f, 5000.0, 3, 30 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Peasant));
            this.waves.add(new Wave(game, 20, 1000 + baseXueLang6 * waves.size(), 1f, 1000.0, 2, 30 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Berserker));
            this.waves.add(new Wave(game, 6, 1000 + baseXueLang6 * waves.size(), 1f, 2000.0, 4, 30 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Doctor));
            this.waves.add(new Wave(game, 6, 0xeac + baseXueLang6 * waves.size(), 0.9f, 1000.0, 30, 30 + (level - 1) * 3, 20 + (level - 1) * 3, MonsterType.Chieftain));
        }

        this.waves.add(new Wave(game, 1, 30000, 0.8f, 1000.0, 30, 50, 50, MonsterType.Chieftain));
